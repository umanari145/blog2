  ...
  return (
    <html lang="ja" className={`${noto.variable} h-full`}>
      <body className="font-sans flex min-h-dvh flex-col antialiased">
        <SiteMobileHeader />
        <div className="mx-auto flex min-h-0 w-full min-w-0 flex-1 flex-col md:w-[65%] md:max-w-[100%] md:grid md:grid-cols-[minmax(0,1fr)_16rem] lg:grid-cols-[minmax(0,1fr)_18rem]">
