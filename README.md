...
| `app/app/api/` | **Route Handler**（`GET /api/posts`・`GET /api/posts/[postNo]`・`GET /api/categories`・`GET /api/categories/[id]/posts`・`GET /api/tags`・`GET /api/tags/[id]/posts`）。実体は `lib/data` |
